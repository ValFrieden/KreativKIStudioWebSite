(() => {
  ...
  const copy = {
    de: {
      ...
      all: 'Alle', brand: 'Marke & Produkt', photo: 'Foto & Erinnerung', motion: 'Film & Animation', original: 'Original', result: 'Ergebnis', film: 'Film', play: 'Film abspielen', aiEdited: 'KI-bearbeitet', aiGenerated: 'KI-generiert', source: 'KI-Ausgangsbild', inquiry: 'Projektanfrage', topPick: 'Studio Auswahl', footerLine: 'Bild · Film · Klang · Web', transparencyTitle: 'Transparenz zu KI-Inhalten', transparencyText: 'Alle Bilder und Videos auf dieser Website sind KI-generiert – auch die als „Original“ oder „KI-Ausgangsbild“ gekennzeichneten Vorher-Ansichten zeigen keine echten Fotografien. Als „KI-bearbeitet“ oder „KI-generiert“ gekennzeichnete Medien wurden mit KI erstellt oder wesentlich bearbeitet.', close: 'Schließen', studioFacts: 'Studio-Fakten', mediaView: 'Medienansicht', filterProjects: 'Projekte filtern', audioTitles: 'Audiotitel', storyCompareLabel: 'Vergleich von KI-Ausgangsbild und KI-bearbeitetem Ergebnis', reference: 'Referenz', removeReference: 'Entfernen', copyBrief: 'Anfrage kopieren', copied: 'Anfrage wurde kopiert.', copyFailed: 'Kopieren ist nicht möglich. Bitte den Text manuell auswählen.', ideaPlaceholder: 'Ein bis drei Sätze genügen.', viewWork: 'Passende Arbeiten', requestService: 'Diese Leistung anfragen'
    },
    en: {
      ...
      all: 'All', brand: 'Brand & product', photo: 'Photo & memory', motion: 'Film & animation', original: 'Source', result: 'Result', film: 'Film', play: 'Play film', aiEdited: 'AI-edited', aiGenerated: 'AI-generated', source: 'AI source image', inquiry: 'Project enquiry', topPick: 'Studio selection', footerLine: 'Image · film · sound · web', transparencyTitle: 'Transparency on AI content', transparencyText: 'All images and videos on this website are AI-generated – even the before views labelled “Original” or “AI source image” are not real photographs. Media labelled “AI-edited” or “AI-generated” was created with AI or substantially edited using AI.', close: 'Close', studioFacts: 'Studio facts', mediaView: 'Media view', filterProjects: 'Filter projects', audioTitles: 'Audio tracks', storyCompareLabel: 'Comparison of AI source image and AI-edited result', reference: 'Reference', removeReference: 'Remove', copyBrief: 'Copy enquiry', copied: 'Enquiry copied.', copyFailed: 'Copying is unavailable. Please select the text manually.', ideaPlaceholder: 'One to three sentences are enough.', viewWork: 'View relevant work', requestService: 'Request this service'
    },
    ru: {
